    ...
    .then(res =>{
      ...
      if(res.status == 200){
        ...
        var data ={
          ...
          user_id: res.data.user__id
        }
        this.props.homePageHandle(data)
      }
      else if(res.data.code == 101){
        console.log("Successful Login");
      }
              ...
              <div className ="form-group">
                <label htmlFor="password" className="mr-4"> Password: </label>
                 ...
                 />
                  ...
                  <a href="#" id="login-btn" onClick={this.CreateaHandlerFunction}><button class="btn btn-success">Login</button></a>
